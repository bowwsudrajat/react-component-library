...
import { ponyfillGlobal } from '@momo/utils';

/* Warning if there are several instances of @momo/styles */
if (
  process.env.NODE_ENV !== 'production' &&
  process.env.NODE_ENV !== 'test' &&
  typeof window !== 'undefined'
) {
  ponyfillGlobal['__@momo/styles-init__'] = ponyfillGlobal['__@momo/styles-init__'] || 0;

  if (ponyfillGlobal['__@momo/styles-init__'] === 1) {
    console.warn(
      [
        'It looks like there are several instances of `@momo/styles` initialized in this application.',
  ...
  ponyfillGlobal['__@momo/styles-init__'] += 1;
}
