...
import Modal from '@momo/material/Modal';
import Dialog, { dialogClasses as classes } from '@momo/material/Dialog';
...
/**
 * @param {typeof import('@momo-internal/test-utils').screen} view
 */
