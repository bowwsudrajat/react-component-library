...
import { ErrorBoundary, act, createRenderer, fireEvent, screen } from '@momo-internal/test-utils';
import { createTheme, ThemeProvider } from '@momo/material/styles';
import MenuItem, { menuItemClasses } from '@momo/material/MenuItem';
import ListSubheader from '@momo/material/ListSubheader';
import InputBase from '@momo/material/InputBase';
import OutlinedInput from '@momo/material/OutlinedInput';
import InputLabel from '@momo/material/InputLabel';
import Select from '@momo/material/Select';
import Divider from '@momo/material/Divider';
...
describe('<Select />', () => {
  ...
  describe('prop: name', () => {
    ...
    it('should have select-`name` id when name is provided', () => {
      ...
      expect(getByRole('combobox')).to.have.attribute('id', 'momo-component-select-foo');
    });
  });
