...
import elementTypeAcceptingRef from '@momo/utils/elementTypeAcceptingRef';
import refType from '@momo/utils/refType';
...
export const InputBaseComponent = styled('input', {
  ...
  return {
    ...
    animationName: 'momo-auto-fill-cancel',
...
const inputGlobalStyles = (
  <GlobalStyles
    styles={{
      '@keyframes momo-auto-fill': { from: { display: 'block' } },
      '@keyframes momo-auto-fill-cancel': { from: { display: 'block' } },
    }}
  />
);
...
const InputBase = React.forwardRef(function InputBase(inProps, ref) {
  ...
  const handleAutoFill = (event) => {
    ...
    checkDirty(event.animationName === 'momo-auto-fill-cancel' ? inputRef.current : { value: 'x' });
  };
    ...
    <React.Fragment>
      ...
      <Root
        ...
        className={clsx(
          classes.root,
          {
            // TODO v6: remove this class as it duplicates with the global state class Momo-readOnly
