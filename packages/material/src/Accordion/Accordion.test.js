...
import { createRenderer, fireEvent } from '@momo-internal/test-utils';
import Accordion, { accordionClasses as classes } from '@momo/material/Accordion';
import Paper from '@momo/material/Paper';
import AccordionSummary from '@momo/material/AccordionSummary';
...
describe('<Accordion />', () => {
  ...
  describe('prop: children', () => {
    describe('first child', () => {
      ...
      it('requires at least one child', () => {
        ...
        }).toErrorDev(['MOMO: Expected the first child']);
      });
      ...
      it('needs a valid element as the first child', () => {
        ...
        }).toErrorDev(["MOMO: The Accordion doesn't accept a Fragment"]);
      });
    });
  ...
  it('should warn when switching from controlled to uncontrolled', () => {
    ...
    expect(() => wrapper.setProps({ expanded: undefined })).to.toErrorDev(
      'MOMO: A component is changing the controlled expanded state of Accordion to be uncontrolled.',
    );
  });
  ...
  it('should warn when switching between uncontrolled to controlled', () => {
    ...
    expect(() => setProps({ expanded: true })).toErrorDev(
      'MOMO: A component is changing the uncontrolled expanded state of Accordion to be controlled.',
    );
  });
