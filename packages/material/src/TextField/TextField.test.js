...
import { inputBaseClasses } from '@momo/material/InputBase';
import MenuItem from '@momo/material/MenuItem';
import { outlinedInputClasses } from '@momo/material/OutlinedInput';
import TextField, { textFieldClasses as classes } from '@momo/material/TextField';
    ...
    it('should forward the fullWidth prop to Input', () => {
      const { getByTestId } = render(
        <TextField
          variant="standard"
          fullWidth
          InputProps={{ 'data-testid': 'momo-input-base-root' }}
        />,
      );

      expect(getByTestId('momo-input-base-root')).to.have.class(inputBaseClasses.fullWidth);
    });
  });
