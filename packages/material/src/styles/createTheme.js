...
} from '@momo/system/styleFunctionSx';
import systemCreateTheme from '@momo/system/createTheme';
...
function createTheme(options = {}, ...args) {
  ...
  if (process.env.NODE_ENV !== 'production') {
    // TODO v6: Refactor to use globalStateClassesMapping from @momo/utils once `readOnly` state class is used in Rating component.
    const stateClasses = [
      'active',
      'checked',
      'completed',
    ...
    if (!warnedOnce) {
      ...
      console.error(
        [
          ...
          '',
          "You should use `import { createTheme } from '@momo/material/styles'`",
        ].join('\n'),
      );
    }
  }
