...
import { unstable_createCssVarsProvider as createCssVarsProvider, SxProps } from '@momo/system';
import styleFunctionSx from '@momo/system/styleFunctionSx';
 ...
 * ```diff
 * - import { getInitColorSchemeScript } from '@momo/material/styles';
