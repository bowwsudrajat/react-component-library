...
import { DistributiveOmit } from '@momo/types';
...
/**
 * @internal
 * ONLY USE FROM WITHIN momo/material-ui
 *
...
/**
 * @deprecated will be removed in v5.beta, please use StyledEngineProvider from @momo/material/styles instead
 */
export { StyledEngineProvider } from './styles';

export { unstable_composeClasses } from '@momo/utils';
