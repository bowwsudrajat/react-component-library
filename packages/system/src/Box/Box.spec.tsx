...
import { Box, styled } from '@momo/system';
...
function CssVariablesWithNestedSelectors() {
  <Box
    sx={(theme) => ({
      '--momo-palette-primary-main': '#FF0000',
    })}
  />;
  <Box
    sx={(theme) => ({
      ...
      '&:hover': {
        ...
        '--momo-palette-primary-main': (t) => theme.palette.primary.main,
        '--momo-spacing': (t) => theme.shape.borderRadius,
      },
    })}
  />;
  <Box
