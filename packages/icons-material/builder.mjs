...
import { Queue } from '@momo/internal-waterfall';

const currentDirectory = fileURLToPath(new URL('.', import.meta.url));

export const RENAME_FILTER_DEFAULT = './renameFilters/default.mjs';
export const RENAME_FILTER_MOMO = './renameFilters/material-design-icons.mjs';
      ...
      builder: (command) => {
        command
          ...
          .option('file-suffix', {
            type: 'string',
            describe:
              'Filter only files ending with a suffix (pretty much only for @momo/icons-material)',
          })
