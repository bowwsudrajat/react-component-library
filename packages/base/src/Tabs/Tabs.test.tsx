...
import { Tab } from '@momo/base/Tab';
import { Tabs, tabsClasses as classes, TabsProps } from '@momo/base/Tabs';
import { TabsList } from '@momo/base/TabsList';
import { TabPanel } from '@momo/base/TabPanel';
